...
-- -----------------------------------------------------
-- Table `socialnetwork`.`hashtag`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `socialnetwork`.`hashtag` (
  `idHashtag` INT NOT NULL AUTO_INCREMENT,
  `idpost` INT NULL,
  `idcomment` INT NULL,
  PRIMARY KEY (`idHashtag`),
  INDEX `fk_Hashtag_has_post_post1_idx` (`idpost` ASC),
  INDEX `fk_post_hashtag_comment1_idx` (`idcomment` ASC),
  CONSTRAINT `fk_Hashtag_has_post_post1`
    FOREIGN KEY (`idpost`)
    REFERENCES `socialnetwork`.`post` (`idpost`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_post_hashtag_comment1`
    FOREIGN KEY (`idcomment`)
    REFERENCES `socialnetwork`.`comment` (`idcomment`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
